...
class Baidu_translate():
    ...
    def request_get(self, translate_obj):
        ...
        cookies = {
            ...
            'Hm_lvt_64ecd82404c51e03dc91cb9e8c025574': '1694751487,1695043849',
            'Hm_lpvt_64ecd82404c51e03dc91cb9e8c025574': '1695044570',
            'ab_sr': '1.0.1_',
        }
        headers = {
            'Accept': '*/*',
            'Accept-Language': 'zh-CN,zh;q=0.9,en;q=0.8',
            'Acs-Token': '1695044723113_1695045153331_',
    ...
    def data_process(self, json_data):
        ...
        data_model['sentence_instances'] = sentence_instances
